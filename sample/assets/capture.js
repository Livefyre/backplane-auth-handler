...
CAPTURE.init = function() {
    ...
    CAPTURE.ageLimitUrl = CAPTURE.config.ageLimitUrl || CAPTURE.signinUrl;
    ...
    CAPTURE.createSession = function(token, fromCookie) {
        ...
        window.janrain.events.onCaptureLoginSuccess.fire();
    };

    CAPTURE.destroySession = function() {
    ...
    CAPTURE.publicProfileFrame = function(uuid) {
        ...
        var srcUrl = this.publicProfilePageUrl(uuid_);
        profileFrame.src = srcUrl;
        profileFrame.frameborder = 0;
    ...
    CAPTURE.koCallback = function() {
        ...
        location.href = "unable_to_login.html";
    };
    ...
    CAPTURE.util.Modal = (function () {
        ...
        _Event.prototype.addHandler = function(callback) {
            this.eventHandlers.push(callback);
        };

        _Event.prototype.removeHandler = function(callback) {
            for (var i=0, l=this.eventHandlers.length; i<l; i++) {
                if (this.eventHandlers[i] == callback) {
        ...
        janrain.events = {};
        // _errors
        if (!window.janrain.events.onCaptureLoginSuccess) {
            window.janrain.events.onCaptureLoginSuccess = _createEvent();
        }
        var errors = function() {
        ...
        function _Modal() {
            ...
            function _createCloseButton() {
                ...
                closeButton.src = 'images/close_ai.png'; // CDNME
